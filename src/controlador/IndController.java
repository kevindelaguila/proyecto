...
public class IndController implements Initializable {
    ...
    private void gestionRegistrar(ActionEvent event) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Cliente agregado", "Nuevo cliente", JOptionPane.INFORMATION_MESSAGE);
            mostrarIndividuales();
            limpiarCampos();
    ...
    private void eliminar(ActionEvent event) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Cliente Eliminado", "Eliminado", JOptionPane.INFORMATION_MESSAGE);
            mostrarIndividuales();
            limpiarCampos();
        } catch (HeadlessException | NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Invalido", "Error", JOptionPane.ERROR_MESSAGE);
