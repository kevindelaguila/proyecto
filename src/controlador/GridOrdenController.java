...
public class GridOrdenController implements Initializable {
    ...
    private void consultarOrden(ActionEvent event) {
        ...
        if (validar == true) {
            ...
            Text cliente = new Text("Informacion");
            ...
            if (orden.getCliente().getTipoCliente().equals("empresa")) {
                ...
                Text valorDescuento = new Text("Descento: ");
            ...
            Text espS = new Text("");
            Text subTotales = new Text("Totales");
            Text valorProducto1 = new Text("Producto No.1: ");
            Text txtValorProducto1 = new Text(Utilerias.formatoMoneda(orden.getItem1().getTotalItem()));
            Text valorProducto2 = new Text("Producto No.2: ");
            ...
            JOptionPane.showMessageDialog(null, "Orden no existe", "Buscar", JOptionPane.INFORMATION_MESSAGE);
        }
